...
function wgrg($flag, $b1, $d1, $h1)
{
    switch ($flag) {
        case 1:
            $D18 = (((5.6 + ((2 - $d1) * 9.5) / 9.5) / 2 + 2) * 4.8 + (5.6 + ((2 - $d1) * 9.5) / 9.5) - 3) * 40;
            $F18 = 150;
            $H18 = 0;
            $B21 = (((4.5 + ((2 - $d1) * 9.5) / 9.5 * 1.5) / 1.8 + 1.8) * 4.8 + (4.5 + ((2 - $d1) * 9.5) / 9.5 * 1.5)) * 40;
            $D21 = ((4.5 + ((2 - $d1) * 9.5) / 9.5 * 1.5) + 9) * 15;
            $F21 = 150;
            $B33 = (($b1 * 0.83) - (14 + ((2 - $d1) * 9.5) / 9.5 * 1.5) - (($d1 - 1) * 9.5) - (5.6 + ((2 - $d1) * 9.5) / 9.5) - (4.5 + ((2 - $d1) * 9.5) / 9.5 * 1.5) - (4.8 + ((2 - $d1) * 9.5) / 9.5 * 0.5) - (($h1 - 1) * 3) - 0) * 40;
            $D33 = 200;
            $F33 = 10 * 50;
            $B37 = (((4.8 + ((2 - $d1) * 9.5) / 9.5 * 0.5 / 3.2 * 2 + 6.4) * 2.7 - 4.8 - 4 + (4.8 + ((2 - $d1) * 9.5) / 9.5 * 0.5))) * 40;
            $D37 = 150;
            $F37 = 150;
            $B40 = (abs(1 - $h1)) * (((($h1 - 1) * 3) / 2 * 2 + 4) * 2.7 + (($h1 - 1) * 3) - 5) * 40;
            $D40 = (abs(1 - $h1)) * 150;
            $F40 = (abs(1 - $h1)) * 100;
