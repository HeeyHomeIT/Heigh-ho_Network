...
function costCalculator_suzhou($calculator_arr)
{
    ...
    $mgrg = mgrg($flag, $area, $room_num, $balcony_num, $bathroom_num, $kitchen_cupboard, $master_wardrobe, $second_wardrobe, $child_wardrobe, $parent_wardrobe, $master_ceiling, $second_ceiling, $child_ceiling, $parlor_ceiling, $parlor_shoebox, $parlor_wine_cabinet, $balcony_hanging_cabinet);
    $yqgrg = yqgrg($flag, $area, $room_num, $bathroom_num);
