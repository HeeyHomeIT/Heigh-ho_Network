!function () {
    function e(e) {
        ...
        function n(e) {
            function n(e, r) {
                e.controllerUrl && r.push(e.controllerUrl), e.dependencies && ("string" == typeof e.dependencies ? r.push(e.dependencies) : [].push.apply(r, e.dependencies))
            }

            var o = [];
            if (n(e, o), e.hasOwnProperty("views") && Object.keys(e.views).forEach(function (r) {
                    n(e.views[r], o)
                }), o.length > 0) {
                var t = e.resolve || {};
                t.$dummy = r(o), e.resolve = t
            }
            return e
        }

        var o = "1.3.2", t = function () {
        ...
        return {
            VERSION: o, configure: function (r) {
                r.provider("ngProviders", ["$controllerProvider", "$compileProvider", "$filterProvider", "$provide", "$injector", function (e, r, n, o, t) {
                    ...
                    var t = n.$controllerProvider, i = n.$compileProvider, u = n.$filterProvider, c = n.$provide;
                    r.useModule = function (t) {
                        var i = e.module(t);
                        if (i.requires)for (var u = 0; u < i.requires.length; u++)r.useModule(i.requires[u]);
    ...
    "function" == typeof define && define.amd ? define(["angular"], function (r) {
        return e(r)
