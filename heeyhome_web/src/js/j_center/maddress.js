...
(function () {
    ...
    var DELETEURL = 'http://hyu2387760001.my3w.com/personal/drive_address/del'; // 删除收货地址信息接口
    var EDITORURL = 'http://hyu2387760001.my3w.com/personal/drive_address/change'; // 编辑收货地址信息接口
    var SETDEFAULTURL = 'http://hyu2387760001.my3w.com/personal/drive_address/setdefault'; // 设置默认收货地址接口
	...
	var addressWrap = {
		...
		editorBtnClickEvent:function(){
			...
			$(".address_editor").on("click",function(){
				...
				// 加载城市插件初始化
				$('.address_content').distpicker({province: editorJSON.province,city:editorJSON.city,district:editorJSON.district});
