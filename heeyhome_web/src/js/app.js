define(['angular', 'require', 'angular-ui-router', 'oclazyLoad', 'ChineseDistricts', 'distpicker', 'pagination','paging','superSlide','dialog','ymdClass','layer'], function(angular, require) {
